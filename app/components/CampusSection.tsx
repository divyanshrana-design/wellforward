...
const DATA = {
  smurfit: {
    ...
    getHere: [
      ...
      { icon: "🚶", title: "Walking", detail: "Blackrock village is a short walk away. Coffee shops, a great Saturday market, and the DART station. Explore it in your first weekend." },
    ],
    spots: [
  ...
  belfield: {
    ...
    spots: [
      ...
      { icon: "💪", cat: "Gym",    title: "UCD Sport & Fitness",        detail: "Full gym on campus. Student membership subsidised. Swim, gym, classes. Busy in September. Sign up early." },
