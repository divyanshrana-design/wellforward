...
// ─── Seed Data: Student Profiles (Smurfit FIT only) ─────────────────────────
...
export const STUDENT_PROFILES: StudentProfile[] = [
  ...
  },
  {
    id: "9",
    name: "Priya",
    course: "MSc Strategic Management",
    school: "Smurfit Business School",
    year: "2025/26",
    country: "India",
    countryFlag: "🇮🇳",
    bio: "Ex-creative, now studying the science behind it. Love strategy, cooking elaborate meals on Sundays, and finding new coffee shops.",
    tags: ["Cooking", "Coffee shops", "Photography", "Travel"],
    instagram: "https://instagram.com",
    linkedin: "https://linkedin.com",
...
// ─── Seed Data: Senior Profiles (Smurfit FIT only) ──────────────────────────
...
export const SENIOR_PROFILES: SeniorProfile[] = [
  {
    ...
    bio: "I arrived in Dublin with two suitcases and absolutely no idea what an IRP was. A year later I am still here doing a placement. Reach out. I was exactly where you are twelve months ago and happy to chat about anything, no question too small.",
  ...
  },
  {
    ...
    bio: "I want to be honest: the first semester was lonely and I didn't expect that. By semester two I had a great group. I'm happy to talk about the social side of being international at UCD. The real experience, not the glossy version.",
  ...
  },
  {
    ...
    bio: "Finance at Smurfit opened a lot of doors in Dublin's IFSC. Happy to tell you which financial firms recruit from Smurfit, which areas to live near the campus in Blackrock, and whether Revolut is enough of a bank account (short answer: not really).",
  ...
  },
  {
    ...
    country: "UAE",
    countryFlag: "🇦🇪",
    askMeAbout: "Smurfit campus life, networking in Dublin, career fairs and placement prep",
    bio: "Strategic Management gave me a really broad toolkit. The year goes quickly and suddenly you are deciding about placement, further study, or going home. If you want to think through your options or just want to know what to expect from the programme, reach out.",
    email: "mailto:a.khan@ucdconnect.ie",
    linkedin: "https://linkedin.com",
